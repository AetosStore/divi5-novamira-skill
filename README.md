...
bash claude-code/divi5-novamira/scripts/install-personal.sh
    1. Optionally upload novamira/divi5-site-workflow.md in Novamira → Skills so the same operating rules travel with the WordPress site and apply to other connected agents too.
Invoke explicitly
In Claude Code:
/divi5-novamira
